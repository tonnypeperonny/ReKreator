...
{
    public class ConcertProvider : IContentProvider
    {
        private readonly AngleSharpParser.HtmlParser parser;
        private readonly IHtmlProvider htmlProvider;
        private readonly IParserConfigProvider configService;
        ...
        {
            var references = await GetAllEventsAsync();

            var eventsList = new List<Event>();
            foreach (var eventUrl in references)
            {
        ...
        {
            var url = configService.GetConcertUrl();
